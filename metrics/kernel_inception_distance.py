...
def compute_kid(opts, max_real, num_gen, num_subsets, max_subset_size, use_torchvision_inception = False):
...
def compute_kid_between_dir(opts, max_real, num_gen, num_subsets, max_subset_size, use_torchvision_inception = False):
    # Direct TorchScript translation of http://download.tensorflow.org/models/image/imagenet/inception-2015-12-05.tgz
    detector_url = None if use_torchvision_inception else 'https://nvlabs-fi-cdn.nvidia.com/stylegan2-ada-pytorch/pretrained/metrics/inception-2015-12-05.pt'
    if opts.progress.verbose:
        print(f'Inception v3: using {"torchvision inception" if detector_url is None else detector_url}')
